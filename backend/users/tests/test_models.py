...
def test_profile_created_when_user_created(test_usertest_user):
...
@pytest.mark.django_db
def test_one_profile_per_user(test_usertest_user):
...
@pytest.mark.django_db
def test_profile_user_relation(test_usertest_user):
